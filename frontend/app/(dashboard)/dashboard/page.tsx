...
export default function DashboardPage() {
  ...
  return (
    <div className="flex-1 space-y-6 container mx-auto px-4 sm:px-6 md:px-8 py-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="p-6 flex flex-col justify-center space-y-4 hover:shadow-md transition-shadow bg-card border-border/60">
          ...
          <div className="p-6 flex-1 flex flex-col">
            ...
            <div className="space-y-4 flex-1">
              {mockAnnouncements.map((notice) => (
                <div key={notice.id} className="p-4 rounded-xl border border-border/50 bg-muted/20 hover:bg-muted/50 transition-colors">
          ...
          <div className="p-6 flex-1 flex flex-col">
            ...
            <div className="space-y-4 flex-1">
              {mockMaintenance.map((item) => (
                <div key={item.id} className="flex items-center justify-between p-4 rounded-xl border border-border/50 bg-muted/20 hover:bg-muted/50 transition-colors">
                  <div className="flex items-center space-x-4">
